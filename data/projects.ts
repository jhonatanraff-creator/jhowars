...
export const projects: Project[] = [
  ...
  { slug:"bestas-do-dia", title:"Bestas do Dia", category:"Ilustração", year:"2024", technique:"Nanquim e pigmento sobre papel", description:"Uma coleção de criaturas cotidianas, desenhadas como registros de um bestiário afetivo. Gestos rápidos encontram formas densas e fabulares.", artFolder:"bestas_do_dia__brazilian_wildlife", contentPath:"/art/bestas_do_dia__brazilian_wildlife/content.md", images:[], featured:true, orientation:"portrait", layout:"offset", tone:"blue" },
  ...
  { slug:"countenance", title:"Countenance", category:"Digital illustration", year:"—", technique:"Digital illustration", description:"The existential crisis is one of the most frequent things in my life. I feel lost most of the time, this illustration shows me what it is like to live in the midst of the chaos of options and the answer not given", artFolder:"countenance__illustration", contentPath:"/art/countenance__illustration/content.md", images:[], featured:true, orientation:"portrait", layout:"compact", tone:"earth" },
  { slug:"o-que-fica", title:"O Que Fica", category:"Editorial Project", year:"—", technique:"Editorial design", description:"“O Que Fica” is an editorial project that embarks on a journey of visual and conceptual exploration. This A4 format book merges form, color, and idea, transforming it into a true art object.", artFolder:"o_que_fica__project_editorial", contentPath:"/art/o_que_fica__project_editorial/content.md", images:[], featured:true, orientation:"landscape", layout:"offset", tone:"ink" },
  { slug:"posters-2024", title:"Posters 2024", category:"Handcrafted Print Collection", year:"2024", technique:"Offset press and screen printing", description:"“Poster 2024” (also known as “Poster Vol 1”) is a curated series of handcrafted prints, created using traditional manual techniques such as offset press and screen printing.", artFolder:"posters_2024__experimental_print_and_illustration", contentPath:"/art/posters_2024__experimental_print_and_illustration/content.md", images:[], featured:true, orientation:"portrait", layout:"compact", tone:"green" },
];
